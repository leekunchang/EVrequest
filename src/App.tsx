  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans antialiased selection:bg-emerald-100 selection:text-emerald-900">
        ...
        <div className="max-w-3xl mx-auto px-4 py-4.5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2.5 bg-white hover:bg-emerald-50 text-emerald-800 rounded-xl text-xs font-extrabold transition-all duration-150 active:scale-95 border-2 border-emerald-600 shadow-md"
              title="입력하신 정보로 실제 신청서 작성 창을 엽니다."
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2.5 bg-emerald-800 hover:bg-emerald-900 rounded-xl text-emerald-100 hover:text-white text-xs font-semibold transition-all duration-150 active:scale-95 border border-emerald-600/30 shadow-inner"
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 py-6 sm:py-8 space-y-6">
        ...
        {/* 아주 친절하고 쉬운 한글 가이드보드 */}
        <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-5 shadow-sm space-y-2">
          ...
          <div className="text-xs text-slate-600 leading-relaxed font-semibold space-y-1">
            <p>1. 하단에 내용을 입력해주세요</p>
            <p>2. 관리자 설정에서 내용을 복사해주세요.</p>
            <p>3. Tampermonkey에 붙여넣기해주세요.</p>
            <p>4. 신청페이지에서 <strong className="text-emerald-800 font-extrabold">주소, 사회계층여부 수동입력 후 이름 입력</strong>하면 끝!</p>
          </div>
        </div>
        ...
        <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="bg-slate-50 px-6 py-4.5 border-b border-slate-100 flex items-center justify-between">
            ...
            <span className="text-[10px] bg-slate-200/70 text-slate-600 px-2 py-0.5 rounded-full font-bold">12개 정보 자동 주입</span>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t border-slate-100">
              <div className="text-xs font-bold text-slate-900 flex items-center gap-2 bg-slate-100 border border-slate-200 px-3.5 py-2 rounded-lg">
                ...
                <span className="text-xs font-bold">3. 제조사 담당자 정보 기입</span>
              </div>
